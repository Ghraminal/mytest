...
<%
	...
	try{
		String sql = "INSERT c.car_number, c.owner_name, p.location, p.entrance_time " +
				"INTO car c, parking p " +
				"where c.car_number = p.car_number " +
				"values(?, ?, ?, ?)";
		...
		pstmt.setString(4, entrance_time);
